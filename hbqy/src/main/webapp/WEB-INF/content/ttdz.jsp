 ...
 <div>
     <div style="width:90%;margin:auto auto;">
         ...
         <table class="table table-hover" >
            ...
            <c:forEach items="${requestScope.ttdz_list}" var="book">      
            <tr>
                <td><img src="img/${book.bookimage }"></td>
                <td>${book.booknomber}</td>
                <td>${book.bookname}</td> 
                <td><a href="seconddetail">点击了解详情</td>
                ...
                <td><a class="btn btn-danger" href="savecollect?book_id=${book.id}" role="button">收藏夹</a></td> 
            </tr>
            </c:forEach>
        </table>
     </div>
