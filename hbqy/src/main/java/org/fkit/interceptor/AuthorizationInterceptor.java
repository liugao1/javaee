...
public class AuthorizationInterceptor  implements HandlerInterceptor {
	...
	private static final String[] IGNORE_URI = {"firstdetail",
			...
			"updatepwd","gaimima","removegood","enroll","find","deleteuser","users","admindoderupdate","removeorder","lisi","good","adminorder","shoper","qingyuchanping","main", "users","login","goodadd","admin","adminlogin","reg"};	
	 /** 
